...
export default function HTMLPreview() {
  ...
  return (
    <div className="flex flex-col  items-center justify-center h-screen bg-indigo-950 text-foreground ">
      {/* Center the HTML previewer card within the screen */}
      <div className="w-full max-w-2xl p-6 rounded-lg shadow-lg bg-card">
        <h1 className="text-2xl font-extrabold mb-4 text-center">HTML Previewer</h1>
        <p className="text-muted-foreground text-blue-600 mb-4 text-center">
        ...
        <div className="grid gap-4">
          ...
          <Textarea
            ...
            className="p-4 rounded-lg border border-input bg-gray-300 text-foreground"
            rows={10}
          />
