...
export default function PomodoroTimer() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-red-200 dark:bg-gray-900">
      {/* Center the Pomodoro timer card within the screen */}
      <Card className="w-full max-w-md p-6 bg-red-500 dark:bg-black shadow-lg rounded-lg">
