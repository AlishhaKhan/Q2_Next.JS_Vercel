...
export default function Calculator() {
  ...
  >
   ...
   >
      ...
      <Card className="w-full max-w-md p-6 bg-green-50 dark:bg-gray-800 shadow-lg rounded-lg border-separate">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex flex-col text-yellow-400 space-y-2">
          ...
          <div className="grid grid-cols-4 gap-2">
            <Button
              variant="outline"
              className="text-2xl font-bold text-pink-700 dark:text-gray-500"
              onClick={add}
            >
              +
            </Button>
            <Button
              variant="outline"
              className="text-2xl font-bold text-green-700 dark:text-gray-500"
              onClick={subtract}
            >
              -
            </Button>
            <Button
              variant="outline"
              className="text-2xl font-bold text-orange-700 dark:text-gray-500"
              onClick={multiply}
            >
              *
            </Button>
            <Button
              variant="outline"
              className="text-2xl font-bold text-purple-900 dark:text-gray-500"
              onClick={divide}
            >
              /
            </Button>
          ...
          {/* Display the result */}
          <div className="flex flex-col text-green-600 space-y-2">
          ...
          <Button variant="outline" className="w-full text-sky-700" onClick={clear}>
            Clear
          </Button>
        </CardContent>
      </Card>
