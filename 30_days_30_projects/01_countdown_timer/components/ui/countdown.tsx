...
export default function Countdown() {
  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center h-screen bg-green-300 dark:bg-yellow-500">
      {/* Timer box container */}
      <div className="bg-pink-600 dark:bg-pink-400-800 shadow-lg rounded-lg p-8 w-full max-w-md">
        ...
        <div className="text-6xl font-bold text-blue-900 dark:text-yellow-500 mb-8 text-center">
          {formatTime(timeLeft)}
        </div>
        ...
        <div className="flex justify-center gap-4">
          <Button
            onClick={handleStart}
            variant="outline"
            className="text-blue-900 dark:text-red-500"
          >
          ...
          <Button
            onClick={handleReset}
            variant="outline"
            className="text-blue-900 dark:text-red-600"
          >
            Reset
          </Button>
        </div>
