...
export default function DigitalClock() {
  ...
  return (
    <main
    style={{
      backgroundImage: `url('/digital-clock-bg-img.jpg')`,
    ...
    <div className="flex items-center justify-center h-screen">
      ...
      <Card className="p-8 shadow-lg rounded-2xl">
        <div className="flex flex-col items-center justify-center text-sky-950 ">
          {/* Header with title */}
          <div className="text-2xl font-bold font-serif tracking-tight">Digital Clock</div>
          {/* Description */}
          <div className="text-sm text-gray-600 dark:text-gray-400 font-serif mb-4">
